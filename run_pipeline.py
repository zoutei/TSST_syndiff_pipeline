...
Usage:
    python -m syndiff_pipeline.run_pipeline --config config.yaml
    python -m syndiff_pipeline.run_pipeline --config recipe.yaml --validate-only
...
from .download import download_ffis, nested_ffi_dir
...
def run_pipeline(cfg, *, validate_only: bool = False):
    ...
    from .pipeline_execute import run_config_pipeline
